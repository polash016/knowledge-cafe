...
const Answer = () => {
    return (
        <div className='w-[95%] mx-auto mt-8 mb-8'>
            ...
            <p><span className='text-xl'>UseEffect</span> hook in react is usually used to fetch data. But it can also perform in a wide range of tasks. Here are some task useEffect can do:
            <ul>
